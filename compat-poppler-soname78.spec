...
Requires: compat-poppler-soname78-bin = %{version}-%{release}
Requires: compat-poppler-soname78-data = %{version}-%{release}
Requires: compat-poppler-soname78-lib = %{version}-%{release}
Requires: compat-poppler-soname78-license = %{version}-%{release}
Requires: compat-poppler-soname78-man = %{version}-%{release}
...
%package abi
Summary: abi components for the compat-poppler-soname78 package.
Group: Default

%description abi
abi components for the compat-poppler-soname78 package.


%package bin
Summary: bin components for the compat-poppler-soname78 package.
Group: Binaries
Requires: compat-poppler-soname78-data = %{version}-%{release}
Requires: compat-poppler-soname78-license = %{version}-%{release}
Requires: compat-poppler-soname78-man = %{version}-%{release}
...
%description bin
bin components for the compat-poppler-soname78 package.


%package data
Summary: data components for the compat-poppler-soname78 package.
Group: Data

%description data
data components for the compat-poppler-soname78 package.


%package dev
Summary: dev components for the compat-poppler-soname78 package.
Group: Development
Requires: compat-poppler-soname78-lib = %{version}-%{release}
Requires: compat-poppler-soname78-bin = %{version}-%{release}
Requires: compat-poppler-soname78-data = %{version}-%{release}
Provides: compat-poppler-soname78-devel = %{version}-%{release}

%description dev
dev components for the compat-poppler-soname78 package.


%package extras
Summary: extras components for the compat-poppler-soname78 package.
Group: Default

%description extras
extras components for the compat-poppler-soname78 package.


%package lib
Summary: lib components for the compat-poppler-soname78 package.
Group: Libraries
Requires: compat-poppler-soname78-data = %{version}-%{release}
Requires: compat-poppler-soname78-license = %{version}-%{release}

%description lib
lib components for the compat-poppler-soname78 package.


%package license
Summary: license components for the compat-poppler-soname78 package.
Group: Default

%description license
license components for the compat-poppler-soname78 package.


%package man
Summary: man components for the compat-poppler-soname78 package.
Group: Default

%description man
man components for the compat-poppler-soname78 package.
...
export LANG=C
export SOURCE_DATE_EPOCH=1542071029
mkdir -p clr-build
pushd clr-build
...
cp COPYING3 %{buildroot}/usr/share/package-licenses/compat-poppler-soname78/COPYING3
cp cmake/modules/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/compat-poppler-soname78/cmake_modules_COPYING-CMAKE-SCRIPTS
pushd clr-build-avx2
%make_install_avx2  || :
popd
pushd clr-build
...
%files abi
%defattr(-,root,root,-)
%exclude /usr/share/abi/libpoppler-cpp.so.0.5.0.abi
%exclude /usr/share/abi/libpoppler-glib.so.8.9.0.abi
%exclude /usr/share/abi/libpoppler-qt5.so.1.15.0.abi
%exclude /usr/share/abi/libpoppler.so.78.0.0.abi
...
%exclude /usr/include/poppler/XpdfPluginAPI.h
...
%exclude /usr/include/poppler/goo/GooMutex.h
...
%exclude /usr/share/package-licenses/compat-poppler-soname78/COPYING
%exclude /usr/share/package-licenses/compat-poppler-soname78/COPYING3
%exclude /usr/share/package-licenses/compat-poppler-soname78/cmake_modules_COPYING-CMAKE-SCRIPTS

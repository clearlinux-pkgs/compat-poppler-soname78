...
%files abi
%defattr(-,root,root,-)
%exclude /usr/share/abi/libpoppler-cpp.so.0.abi
%exclude /usr/share/abi/libpoppler-glib.so.8.abi
%exclude /usr/share/abi/libpoppler-qt5.so.1.abi
%exclude /usr/share/abi/libpoppler.so.78.abi
